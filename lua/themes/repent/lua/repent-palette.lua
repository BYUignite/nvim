...
M.c = {
    ...
    red = hsl(  0, 50, 50),  -- #bf4040
    org = hsl( 30, 50, 50),  -- #bf8040
    yel = hsl( 60, 50, 50),  -- #bfbf40
    ylg = hsl( 90, 50, 50),  -- #80bf40
    grn = hsl(120, 50, 40),  -- #339933
    grb = hsl(150, 50, 40),  -- #339966
    blg = hsl(180, 50, 40),  -- #339999
    blu = hsl(210, 50, 50),  -- #4080bf
    blp = hsl(240, 50, 50),  -- #4040bf
    prb = hsl(270, 50, 50),  -- #8040bf
    pnk = hsl(300, 50, 50),  -- #bf40bf
    prp = hsl(320, 50, 50),  -- #bf4095
    ppr = hsl(350, 50, 50),  -- #bf4055
